...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('👻 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ', url="https://t.me/MrAK_LinkZz"),
            ...
            msg = await client.send_cached_media(
                ...
                reply_markup=(
                    InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('🌈 ɴʟᴏᴀᴅ 🌈', callback_data=f'gen_stream_link:{file_id}'),
                            ],[
            ...
            msg = await client.send_cached_media(
                ...
                reply_markup=(
                    InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('🌈 Wᴀᴛᴄʜ Oɴʟɪɴᴇ  🌈', callback_data=f'gen_stream_link:{file_id}'),
                            ],[
                                InlineKeyboardButton("✨ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ✨", url="https://t.me/MrAK_LinkZz")
                            ]
                        ]
    ...
    msg = await client.send_cached_media(
        ...
        reply_markup=(
                    InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('🌈 Fᴀꜱᴛ Dᴏᴡɴʟᴏᴀᴅ 🌈', callback_data=f'gen_stream_link:{file_id}')
                            ]
                        ]
                    )
                    )
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink krownlinks.com 1f1da5c9df9a58058672ac8d8134e203b03426a1\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - krownlinks.com ]]]\n\nIf you have any Doubts, Feel Free to Ask me - @I_Am_MrAK\n\n(Puriyala na intha id ku message pannunga - @I_Am_MrAK)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
